...
public:
    CMainParams()
    {
        ...
        nZerocoinStartHeight = 999999;
        nZerocoinStartTime = 9998214600; // very far in the future, to be deleted.
        ...
        nBlockStakeModifierlV2 = 1967000; //test V1 first then implement V2 immediately?
        nBIP65ActivationHeight = 1808634; //more research required into BIP65?
