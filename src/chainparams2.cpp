...
public:
    CMainParams()
    {
        ...
        nZerocoinStartHeight = 99999999; //Zerocoin to be perm. disabled.
        nZerocoinStartTime = 1508214600; // October 17, 2017 4:30:00 AM
        nBlockEnforceSerialRange = 8954000; //More research needed into this variable
        nBlockRecalculateAccumulators = 908000; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = 891737; //First expected block that bad serials emerge
        nBlockLastGoodCheckpoint = 891730; //Last valid accumulator checkpoint
        nBlockEnforceInvalidUTXO = 902850; //Start enforcing the invalid UTXO's
        nInvalidAmountFiltered = 0*COIN; //None currently!
        nBlockZerocoinV2 = 9999999; //!> The block that zerocoin v2 becomes active - never!
        nBlockDoubleAccumulated = 1050010;
        nEnforceNewSporkKey = 1566860400; //!> Spork must be updated.
        nRejectOldSporkKey = 1569538800; //!> Fully reject old spork key after Thursday, September 26, 2019 11:00:00 PM GMT
        nBlockStakeModifierlV2 = 101; //Same block as when PoS becomes active. May need to be revised.
        nBIP65ActivationHeight = 1808634; //more research required.
        ...
        // Fake Serial Attack //our new fork does not contain any fake serial attacks as of yet.
        ...
        vSeeds.push_back(CDNSSeedData("165.22.231.39", "165.22.231.39"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("165.22.42.81", "165.22.42.81"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("167.71.102.31", "167.71.102.31"));    // Primary DNS Seeder from warrows A
        ...
        nBudgetCycleBlocks = 43200; //!< Amount of blocks in a months period of time (using 1 minutes per block = (60*24*30)
        ...
        nMinZerocoinMintFee = 10000 * CENT; //high fee required for zerocoin mints
        ...
        nProposalEstablishmentTime = 60 * 60 * 2400; // Proposals must be at least 2400 hours old to make it into a budget
    }
