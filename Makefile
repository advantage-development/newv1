...
ACLOCAL = ${SHELL} /root/pivx/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/pivx/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/pivx/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/pivx/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /root/pivx/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Pivx Core 3.4.99
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/pivx
abs_srcdir = /root/pivx
abs_top_builddir = /root/pivx
abs_top_srcdir = /root/pivx
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/pivx/build-aux/install-sh
